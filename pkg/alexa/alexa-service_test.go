...
func TestGetPriceMessage(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			t:              time.Date(2023, 1, 1, 3, 30, 0, 0, madridLocation),
			lang:           language.English,
			shouldContain1: "The current price is 10 cents",
		},
		{
			...
			lang:           language.Spanish,
			shouldContain1: "El precio actual es 20 céntimos",
		},
		{
			name: "No data (English)",
			prices: []price.Price{
...
func TestGetFullFeed(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockErrorTmrw:  nil,
			lang:           language.English,
			shouldContain1: "Today is a good day with an average price of 10 cents",
			shouldContain2: "The current price is 2 cents",
			shouldContain3: "The next cheap period starts at 10 AM with an average price of 11 cents and will end at 11 AM",
			shouldContain4: "The next expensive period starts at 2 AM with an average price of 4 cents and will end at 5 AM",
			shouldContain5: "Tomorrow is a normal day with an average price of 15 cents",
		},
		{
			...
			mockErrorTmrw:  nil,
			lang:           language.Spanish,
			shouldContain1: "Hoy es un día bueno, con un precio medio de 10 céntimos.",
			shouldContain2: "El precio actual es 2 céntimos.",
			shouldContain3: "El próximo período barato comienza a las 10 AM con un precio medio de 11 céntimos y terminara a las 11 AM.",
			shouldContain4: "El próximo período caro comienza a las 2 AM con un precio promedio de 4 céntimos y terminara a las 5 AM.",
			shouldContain5: "Mañana es un día normal, con un precio promedio de 15 céntimos.",
		},
		{
			...
			lang:           language.English,
			shouldContain1: "Today is a good day with an average price of 10 cents",
			shouldContain2: "The current price is 13 cents",
			shouldContain3: "The next cheap period starts at 1 PM with an average price of 14 cents and will end at 2 PM",
		...
		},
		{
			...
			lang:           language.English,
			shouldContain1: "Today is a good day with an average price of 10 cents",
			shouldContain2: "The current price is 7 cents",
			shouldContain3: "The next cheap period starts at 10 AM with an average price of 11 cents and will end at 11 AM",
			shouldContain4: "The next expensive period starts at 8 AM with an average price of 9 cents and will end at 9 AM",
			shouldContain5: "Tomorrow is a normal day with an average price of 15 cents",
		},
		{
			...
			lang:           language.English,
			shouldContain1: "Today is a good day with an average price of 10 cents",
			shouldContain2: "The current price is 24 cents",
...
func TestProcessAlexaSkillRequest(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectMessage:     "Today is a good day with an average price of 10 cents. The current price is 2 cents. The next cheap period starts at 10 AM with an average price of 11 cents and will end at 11 AM. The next expensive period starts at 2 AM with an average price of 4 cents and will end at 5 AM.",
			expectEnd:         false,
		},
		{
			name: "FULL (Spanish)",
			...
			mockFullFeedError: nil,
			expectMessage:     "Hoy es un día bueno, con un precio medio de 10 céntimos. El precio actual es 2 céntimos. El próximo período barato comienza a las 10 AM con un precio medio de 11 céntimos y terminara a las 11 AM. El próximo período caro comienza a las 2 AM con un precio promedio de 4 céntimos y terminara a las 5 AM.",
			expectEnd:         false,
		},
		{
			name: "FULL - error",
		...
		},
		{
			...
			expectMessage:       "Today is a good day with an average price of 10 cents.",
			expectEnd:           false,
		},
		{
			name: "TODAY (Spanish)",
			...
			mockDayAverage:      0.2,
			mockDayAverageError: nil,
			expectMessage:       "Hoy es un día malo, con un precio medio de 20 céntimos.",
			expectEnd:           false,
		},
		{
		...
		},
		{
			...
			mockDayAverage:      0.1,
			mockDayAverageError: nil,
			expectMessage:       "Tomorrow is a normal day with an average price of 10 cents.",
			expectEnd:           false,
		},
		{
			...
			mockDayAverage:      0.2,
			mockDayAverageError: nil,
			expectMessage:       "Mañana es un día malo, con un precio promedio de 20 céntimos.",
			expectEnd:           false,
		},
		{
		...
		},
		{
			...
			expectMessage:     "You are currently in a cheap period that started at 10 AM with an average price of 11 cents and will end at 11 AM.",
			expectEnd:         false,
		},
		{
			...
			mockGetCheapError: nil,
			expectMessage:     "Actualmente se encuentra en un período barato que comenzó a las 10 AM con un precio promedio de 11 céntimos y terminara a las 11 AM.",
			expectEnd:         false,
		},
		{
		...
		},
		{
			...
			mockGetPriceErr: nil,
			expectMessage:   "The current price is 11 cents.",
			expectEnd:       false,
		},
		{
			...
			mockGetPriceErr: nil,
			expectMessage:   "El precio actual es 10 céntimos.",
			expectEnd:       false,
		},
		{
		...
		},
		{
			...
			expectMessage:    "The average price for the last 30 days is 10 cents.",
			expectEnd:        false,
		},
		{
			...
			mockThirtyDayErr: nil,
			expectMessage:    "El precio promedio de los últimos 30 días es 20 céntimos.",
			expectEnd:        false,
		},
		{
